...
@EnableFeignClients
public class RsMortgageCustomerBackgroundCheckRestAPIApplication extends SpringBootServletInitializer {

    private static final Class<RsMortgageCustomerBackgroundCheckRestAPIApplication> applicationClass = RsMortgageCustomerBackgroundCheckRestAPIApplication.class;
